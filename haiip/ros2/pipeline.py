...
async def run_pipeline(
    ...
    tasks = [
        ...
        asyncio.create_task(economic_coroutine(ai_q, decision_q), name="economic"),
        asyncio.create_task(action_coroutine(decision_q, command_q, override_q), name="action"),
        asyncio.create_task(_command_sink(command_q), name="sink"),
        asyncio.create_task(StandaloneHumanOverride(machine_id, override_q).run(), name="override"),
    ]
